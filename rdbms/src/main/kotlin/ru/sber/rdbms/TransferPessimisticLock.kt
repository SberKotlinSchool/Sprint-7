...
import ru.sber.rdbms.exception.NotEnoughMoneyOnAccountException
    ...
    fun transfer(accountId1: Long, accountId2: Long, amount: Long) {
        ...
        connection.use { conn ->
            ...
            try {
                ...
                if (amount1 - amount < 0) throw NotEnoughMoneyOnAccountException("Недостаточно средств на счете")
